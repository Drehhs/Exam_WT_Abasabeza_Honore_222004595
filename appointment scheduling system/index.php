...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">APS. </font>
                    <font class="edoc-logo-sub">-APPOINTMENT SCHEDULING SYSTEM-</font>
                </td>
                <td width="10%">
        ...
        <p class="sub-text2 footer-hashen">A Web Designed  by Abasabeza Honore.</p>
    </center>
